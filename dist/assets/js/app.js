...
var _typed = __webpack_require__(38);
...
var typed3 = new _typed2.default('.element', {
...
(0, _jquery2.default)(window).scroll(function () {
    ...
    if (scroll > 0) {
        (0, _jquery2.default)("#header").addClass("shadow");
    } else {
        (0, _jquery2.default)("#header").removeClass("shadow");
    }
});
